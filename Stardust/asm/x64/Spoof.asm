...
Spoof:
    ...
    add r14, [rdi + 48]     ; stack size of gadget
    add r14, [rdi + 32]     ; stack size of BTIT
    ...
    ; ----------------------------------------------------------------------
    ; Creating working space for the frames.
    ; ----------------------------------------------------------------------

    sub rsp, [rdi + 48]     ; Stack size
    sub rsp, [rdi + 32]     ; Stack size
    sub rsp, [rdi + 56]     ; Stack size
