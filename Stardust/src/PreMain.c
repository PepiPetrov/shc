...
ST_GLOBAL PVOID __Instance = NULL;
    ...
    PVOID Param)
{
    ...
    Stardust.Peb = NtCurrentPeb();

    //
    // get the process heap handle from Peb
    //
    Heap = Stardust.Peb->ProcessHeap;
    ...
    Stardust.Magic = INSTANCE_HEAP_MAGIC;
    ...
    NtCurrentPeb()->ProcessHeaps[NtCurrentPeb()->NumberOfHeaps++] = &Stardust;
